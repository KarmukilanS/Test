...
//Pick my Tickets
		...
		WebElement TicketSelection = driver.findElement(By.xpath("//input[@class='timesheet-ticket dynamic-autocomplete ui-control ui-mandatory ui-autocomplete-input']"));
		TicketSelection.sendKeys("Python Training");
...
//Select createdTicket = new Select(driver.findElement(By.xpath("/html/body/div[4]/div/div/div[1]/table/tbody/tr[1]/td[4]/select")));
//createdTicket.selectByVisibleText("on-premise");
//createdTicket.selectByIndex(2);
//		  
//Select reason = new Select(driver.findElement(By.xpath("/html/body/div[4]/div/div/div[1]/table/tbody/tr[1]/td[5]/select")));
//reason.selectByVisibleText("bench");
...
// Time and Description --------------------------------------------------------------------- //	
		...
		Assert.assertEquals(driver.findElement(By.xpath("/html/body/div[4]/div/div/div[1]/div[2]/ul/li")).getText(), "A timesheet entry of - 09:00 Hrs has been logged to the employee - karmukilan.selva under reason - bench for Task #6026 dated 24-Mar-2023.");
	}
